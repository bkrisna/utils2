 ...
 */
Ext.define('CImeetsExtJS.view.exautils.layout.PortalPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.portalpanel',

    requires: [
        'Ext.layout.container.Column',
        'CImeetsExtJS.view.exautils.layout.PortalDropZone',
        'CImeetsExtJS.view.exautils.layout.PortalColumn'
    ],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('CImeetsExtJS.view.exautils.layout.PortalDropZone', this, this.dropConfig);
    },
