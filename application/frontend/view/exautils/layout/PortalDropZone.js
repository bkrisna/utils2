 ...
 */
Ext.define('CImeetsExtJS.view.exautils.layout.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        CImeetsExtJS.view.exautils.layout.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        CImeetsExtJS.view.exautils.layout.PortalDropZone.superclass.unreg.call(this);
    }
});
